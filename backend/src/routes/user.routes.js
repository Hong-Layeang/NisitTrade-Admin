...
import deleteUserController from '../controllers/user/delete_user.controller.js';
...
router.delete('/:id', authMiddleware, requireRole('admin'), deleteUserController); // delete user (admin only)
